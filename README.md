...
Version: 0.1.0 (development channel)
...
This native editor design requires Deucarian Editor 1.10.8 or newer.
...
other packages. Editor must resolve to 1.10.8 or newer. Git dependencies are
